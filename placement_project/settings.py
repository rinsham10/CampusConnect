...
SECRET_KEY = 'django-insecure-yjnpnkg0elq1skuvuc+*8!@pp#$x@!j#g3mwaso3nki_c=50)y'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API documentation for the Placement Portal project.',
    'VERSION': '1.0.0',
